...
import { ConflictError, ResourceNotFoundError, UnexpectedError, ValidationError } from "../../../api/common/Errors";
...
type UpdateNewsFeedError = ConflictError | ResourceNotFoundError | UnexpectedError | ValidationError;
...
export class UpdateNewsFeedUseCase extends AdminUseCase<
    ...
    public async run({ itemId, item }: CreateNewsFeedArg): Promise<Either<UpdateNewsFeedError, ActionResult>> {
        const notFoundError = {
