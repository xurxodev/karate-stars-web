import { Either, EitherAsync, Id, NewsFeed, NewsFeedRawData, ValidationErrors, ValidationErrorsDictionary } from "karate-stars-core";
...
export class CreateNewsFeedUseCase extends AdminUseCase<
    ...
    public async run({ item }: CreateNewsFeedArg): Promise<Either<CreateNewsFeedError, ActionResult>> {
