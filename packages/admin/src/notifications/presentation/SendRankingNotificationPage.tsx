...
import SendRankingNotificationBloc from "./SendRankingNotificationBloc";

const SendRankingNotificationPage: React.FC = () => {
    const bloc = di.get(SendRankingNotificationBloc);
    ...
    return (
        <MainLayout title={"Send Ranking Push Notification"}>
            <BlocBuilder
                bloc={bloc}
...
export default SendRankingNotificationPage;
